        ...
        <div class="bg-white rounded-2xl shadow-xl border border-sky-100 p-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">
                    Sudah punya akun?
                    <a href="{{ route('login') }}" class="text-navy-700 hover:text-navy-900 font-semibold transition">Masuk di sini</a>
                </p>
            </div>
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-5">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <label for="terms" class="text-sm text-gray-600">
                        Saya menyetujui <a href="#" class="text-navy-700 hover:text-navy-900 font-semibold">Syarat & Ketentuan</a>
                        serta <a href="#" class="text-navy-700 hover:text-navy-900 font-semibold">Kebijakan Privasi</a> TirtaX
                    </label>
                </div>
