...
@section('title', 'Edit User - TirtaX')
...
@section('content')
    <div class="max-w-2xl mx-auto px-4 py-8">
        ...
        <div class="bg-gradient-to-r from-navy-900 to-navy-800 rounded-2xl shadow-xl p-8 mb-8 text-white">
            <h1 class="text-3xl font-bold mb-2">✏️ Edit User</h1>
            <p class="text-sky-200">Ubah informasi user {{ $user->name }}.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-sky-100 p-8">
            <form action="{{ route('admin.users.update', $user->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-navy-900 mb-2">Password Baru <span
                            class="text-gray-400 text-xs font-normal">(Kosongkan jika tidak ingin mengubah)</span></label>
